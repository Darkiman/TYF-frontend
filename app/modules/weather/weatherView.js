...
const getWeatherInfo = (weatherInfo) => {
  ...
  const info = temperature
    ...
    : 'No Weather Info Available. Make sure you provided a valid API key in the `apiConfig.js` file.';
...
const WeatherView = (props: Props) => {
  ...
  const hasWeatherData = Object.keys(weatherInfo ? weatherInfo : {} ).length;
